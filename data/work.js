const items = [
  {
    ...
    company: 'Demandlane',
    companyLogo: '/static/images/Company/Demandlane.png',
    companyUrl: 'https://demandlane.com',
    ...
    technologies: ['Performance Marketing', 'Creative Strategy', 'Data Analytics', 'Campaign Optimization'],
    highlights: [
  ...
  },
  {
    ...
    companyLogo: '/static/images/Company/GrowthSchool.svg',
    companyUrl: 'https://growthschool.io',
    ...
    technologies: ['Performance Marketing', 'Growth Strategy', 'Revenue Operations', 'Program Management'],
    highlights: [
  ...
  {
    jobTitle: 'Campaign Intern',
    company: 'Viral Fission',
    companyLogo: '/static/images/Company/ViralFission.png',
    companyUrl: '',
    ...
    technologies: ['Social Media Marketing', 'UGC Campaigns', 'Branded Filters', 'Influencer Marketing'],
    highlights: [
